...
JNIEXPORT void JNICALL Java_org_gameplay_GamePlayNativeActivity_gamepadEventConnectedImpl(JNIEnv* env, jclass clazz, jint deviceId, jint buttonCount, jint joystickCount, jint triggerCount, jstring deviceName)
{
...
JNIEXPORT void JNICALL Java_org_gameplay_GamePlayNativeActivity_gamepadEventDisconnectedImpl(JNIEnv* env, jclass clazz, jint deviceId)
{
    gameplay::Platform::gamepadEventDisconnectedInternal(deviceId);
}

JNIEXPORT void JNICALL Java_org_gameplay_GamePlayNativeActivity_screenOrientationChanged(JNIEnv* env, jclass clazz, jint orientation)
{
